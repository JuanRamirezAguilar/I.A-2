...
class Aspiradora:
    ...
    """def mover(self) -> None:
        # Movimiento del agente que se maneja alatoriamente
    ...
    # Direcciones posibles en que la aspiradora puede moverse en el entorno
    def mover(self) -> None:
        if self.destino_x is not None and self.destino_y is not None:
            ...
            # Si se ha llegado al destino, reiniciar el destino
...
class Entorno:
    ...
    def generar_suciedad(self) -> None:
        celdas_ocupadas = set()  # Para rastrear las celdas que ya tienen suciedad
...
def main() -> None:
    ...
    for i in range(numero_simulaciones):
        ...
        while iteracion < tiempo_simulacion and aspiradora_agente.suciedad != 0:
            ...
            pygame.display.flip()
            clock.tick(20) # Aumentar o disminuir para la velocidad de la simulacion
            iteracion += 1
        
        # Almacenar la puntuación y los movimientos tras cada simulación
